<?php $salidaD = "http://localhost/muerte-x2/apirest/controles/salidaDetalle.php?op=GetAll"; 
    $curl = curl_init();
...
<?php 
$url = "http://localhost/muerte-x2/apirest/controles/salidaDetalle.php?op=delete"; 
