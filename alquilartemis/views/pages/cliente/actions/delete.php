<?php $cliente = "http://localhost/SkylAb-145/Proyects/muerte-x2/apirest/controles/cliente.php?op=GetAll"; 
    $curl = curl_init();
...
<?php 
$url = "http://localhost/SkylAb-145/Proyects/muerte-x2/apirest/controles/cliente.php?op=delete"; 
