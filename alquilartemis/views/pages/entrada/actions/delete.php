<?php $entrada = "http://localhost/SkylAb-145/Proyects/muerte-x2/apirest/controles/entrada.php?op=GetAll"; 
    $curl = curl_init();
...
<?php 
$url = "http://localhost/SkylAb-145/Proyects/muerte-x2/apirest/controles/entrada.php?op=delete"; 
