<?php $producto = "http://localhost/SkylAb-145/Proyects/muerte-x2/apirest/controles/producto.php?op=GetAll"; 
    $curl = curl_init();
...
<?php 
$url = "http://localhost/SkylAb-145/Proyects/muerte-x2/apirest/controles/producto.php?op=delete"; 
