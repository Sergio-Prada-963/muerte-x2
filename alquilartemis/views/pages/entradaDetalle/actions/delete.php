<?php $entradaD = "http://localhost/muerte-x2/apirest/controles/entradaDetalle.php?op=GetAll"; 
    $curl = curl_init();
...
<?php 
$url = "http://localhost/muerte-x2/apirest/controles/entradaDetalle.php?op=delete"; 
